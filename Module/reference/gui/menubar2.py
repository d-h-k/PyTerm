...
menu_edit.add_command(label = "color", command = color)
menu_edit.add_command(label = "style", command = style)
menu_edit.add_command(label = "convention", command = convention)
